...
<div class="container">
    ...
    <form method="post" action="${SITE_URL}/admin/course/save">
        ...
        <div class="form-group">
            ...
            <textarea name="description" placeholder="Course Description"class="form-control" required="required"/></textarea>
        </div>
        <div class="form-group">
            <label>Fees</label>
            <input type="text" class="form-control" name="fees" placeholder="Course Fee(NRs)"/>
        </div>
        <div class="checkbox">
            <label>Status</label>
