        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p class="pull-left"><label>Student ID:</label></p> <p class="pull-right">${account.studentId.studentId}</p>
                    </div>
                    <div class="col-md-12">
                        <p class="pull-left"><label>Student Name:</label></p> <p class="pull-right">${account.studentId.firstName} ${account.studentId.middleName} ${account.studentId.lastName}</p>
                    </div>
                    <div class="col-md-12">
                        <p class="pull-left"><label>Course Name:</label></p> <p class="pull-right">${account.studentId.courseId.courseName}</p>
                    </div>
                    <div class="col-md-12">
                        <p class="pull-left"><label>Course Fee(NRs):</label></p> <p class="pull-right">${account.studentId.courseId.fees}</p>
                    </div>
                    <div class="col-md-12">
